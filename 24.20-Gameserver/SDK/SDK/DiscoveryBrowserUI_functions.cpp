...
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// const class FText&                      JoinablePartySubText                                   (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// const int32                             CurrentPartyCount                                      (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const int32                             MaxPartyCount                                          (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const bool                              bIsActiveInvite                                        (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const bool                              bIsPartyPrivate                                        (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
