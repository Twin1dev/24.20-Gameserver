...
public:
	...
	TMulticastInlineDelegate<void(const class AFortAthenaAIBotController* AIBotController, class AFortPickup* PickUp)> OnPickupCreated; // 0x0400(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void(const class AFortPlayerPawn* KilledPlayerPawn)> OnPlayerPawnKilledByBot; // 0x07F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
