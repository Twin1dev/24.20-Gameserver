...
public:
	...
	TMulticastInlineDelegate<void(const TArray<TScriptInterface<class IFortAthenaLivingWorldPointProviderInterface>>& EnabledPointProviders)> OnCompletedEvaluationDelegate; // 0x0330(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
public:
	...
	TMulticastInlineDelegate<void(const TArray<class AActor*>& SpawnedActors)> OnAllActorSpawnedDelegate; // 0x08C0(0x0010)(ZeroConstructor, Transient, InstancedReference, Protected, NativeAccessSpecifierProtected)
