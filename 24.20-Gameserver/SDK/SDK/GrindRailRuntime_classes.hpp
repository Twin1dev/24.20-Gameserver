...
public:
	...
	TMulticastInlineDelegate<void(const struct FGrindRailMeshInfo& PreviousRailMeshInfo, const struct FGrindRailMeshInfo& NewRailMeshInfo)> GrindMeshChangedDelegate; // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
