...
public:
	...
	TMulticastInlineDelegate<void(const class FName Socket, const float ImpactSpeed, const struct FHitResult& OutHit)> OnSpringImpact; // 0x1AF0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
