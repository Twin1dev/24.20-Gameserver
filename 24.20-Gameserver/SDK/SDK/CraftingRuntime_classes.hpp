...
{
public:
	TMulticastInlineDelegate<void(class AFortPlayerController* Instigator, class AActor* CraftingObject, const class FName& FormulaRowName)> OnCraftingSuccess; // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
